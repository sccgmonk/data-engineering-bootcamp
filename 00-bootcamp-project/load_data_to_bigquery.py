...
# keyfile = "deb4-load-file-to-bigquery.json" # แก้ไขชื่อ keyfile ให้ถูกต้อง
keyfile = "load_data_to_bigquery_su.json"
service_account_info = json.load(open(keyfile))
credentials = service_account.Credentials.from_service_account_info(service_account_info)
project_id = "my-project-de-434208" # แก้ไข project_id ให้สอดคล้องกับ GCP project ของตัวเอง
